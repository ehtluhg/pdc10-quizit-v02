...
<body class="index-page">
  ...
  <section class="mt-5 pb-4" id="count-stats">
    ...
    <div class="container">
      <div class="row">
        <h1 class="d-flex justify-content-center mt-6"> Practice </h1>
        <hr>
      </div>
      <div class="row">
        ...
        <div class="col-8 container justify-content-center" style="margin-left: 190px;"">
              ...
              <div class="position-relative border-radius-xl overflow-hidden shadow-lg mb-7">
                ...
                <div class="tab-content tab-space">
                  <div class="tab-pane active" id="preview-nav-light">
                    <iframe class="w-100 height-300" srcdoc=' <!doctype html>
                      <meta charset="utf-8">
                      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                      <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
                      <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
                      <link href="https://unpkg.com/soft-ui-design-system@1.0.4/assets/css/soft-design-system.min.css" rel="stylesheet" /><!-- Navbar Light -->
